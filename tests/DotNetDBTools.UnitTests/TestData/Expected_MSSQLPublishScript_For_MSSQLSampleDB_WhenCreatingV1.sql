...
--QUERY START: InsertDNDBTSysInfoQuery
DECLARE @ID UNIQUEIDENTIFIER = 'bfb9030c-a8c3-4882-9c42-1c6ad025cf8f';
DECLARE @ParentID UNIQUEIDENTIFIER = NULL;
...
--QUERY START: InsertDNDBTSysInfoQuery
DECLARE @ID UNIQUEIDENTIFIER = 'c480f22f-7c01-4f41-b282-35e9f5cd1fe3';
...
--QUERY START: InsertDNDBTSysInfoQuery
DECLARE @ID UNIQUEIDENTIFIER = '5a0d1926-3270-4eb2-92eb-00be56c7af23';
DECLARE @ParentID UNIQUEIDENTIFIER = 'bfb9030c-a8c3-4882-9c42-1c6ad025cf8f';
...
--QUERY START: InsertDNDBTSysInfoQuery
DECLARE @ID UNIQUEIDENTIFIER = '299675e6-4faa-4d0f-a36a-224306ba5bcb';
DECLARE @ParentID UNIQUEIDENTIFIER = NULL;
...
--QUERY START: InsertDNDBTSysInfoQuery
DECLARE @ID UNIQUEIDENTIFIER = 'a2f2a4de-1337-4594-ae41-72ed4d05f317';
...
--QUERY START: InsertDNDBTSysInfoQuery
DECLARE @ID UNIQUEIDENTIFIER = 'fe68ee3d-09d0-40ac-93f9-5e441fbb4f70';
DECLARE @ParentID UNIQUEIDENTIFIER = '299675e6-4faa-4d0f-a36a-224306ba5bcb';
DECLARE @Name NVARCHAR(MAX) = 'MyColumn2';
INSERT INTO DNDBTDbObjects
(
...
--QUERY START: InsertDNDBTSysInfoQuery
DECLARE @ID UNIQUEIDENTIFIER = '6e95de30-e01a-4fb4-b8b7-8f0c40bb682c';
DECLARE @ParentID UNIQUEIDENTIFIER = '299675e6-4faa-4d0f-a36a-224306ba5bcb';
...
--QUERY START: InsertDNDBTSysInfoQuery
DECLARE @ID UNIQUEIDENTIFIER = '37a45def-f4a0-4be7-8bfb-8fbed4a7d705';
DECLARE @ParentID UNIQUEIDENTIFIER = '299675e6-4faa-4d0f-a36a-224306ba5bcb';
...
--QUERY START: InsertDNDBTSysInfoQuery
DECLARE @ID UNIQUEIDENTIFIER = 'f3f08522-26ee-4950-9135-22edf2e4e0cf';
DECLARE @ParentID UNIQUEIDENTIFIER = '299675e6-4faa-4d0f-a36a-224306ba5bcb';
...
--QUERY START: InsertDNDBTSysInfoQuery
DECLARE @ID UNIQUEIDENTIFIER = '6ca51f29-c1bc-4349-b9c1-6f1ea170f162';
DECLARE @ParentID UNIQUEIDENTIFIER = NULL;
...
--QUERY START: InsertDNDBTSysInfoQuery
DECLARE @ID UNIQUEIDENTIFIER = '5309d66f-2030-402e-912e-5547babaa072';
...
--QUERY START: InsertDNDBTSysInfoQuery
DECLARE @ID UNIQUEIDENTIFIER = '15ae6061-426d-4485-85e6-ecd3e0f98882';
DECLARE @ParentID UNIQUEIDENTIFIER = '6ca51f29-c1bc-4349-b9c1-6f1ea170f162';
DECLARE @Name NVARCHAR(MAX) = 'MyColumn2';
INSERT INTO DNDBTDbObjects
(
