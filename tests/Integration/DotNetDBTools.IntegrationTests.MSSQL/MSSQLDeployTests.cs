...
namespace DotNetDBTools.IntegrationTests.MSSQL
{
    ...
    public class MSSQLDeployTests
    {
        ...
        private static readonly string s_mssqlSampleDbAssemblyPath = $"{RepoRoot}/samples/Databases/DotNetDBTools.SampleDB.MSSQL/bin/DbAssembly/DotNetDBTools.SampleDB.MSSQL.dll";
