...
namespace DotNetDBTools.SampleSelfUpdatingApp.MSSQL
{
    public static class Program
    {
        ...
        private static readonly string s_connectionString = $"Data Source=127.0.0.1,{MsSqlServerHostPort};Initial Catalog={AgnosticDatabaseName};Integrated Security=False;User ID=SA;Password={MsSqlServerPassword};TrustServerCertificate=true";
