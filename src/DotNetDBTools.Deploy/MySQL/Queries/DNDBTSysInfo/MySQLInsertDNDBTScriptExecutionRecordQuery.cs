...
internal class MySQLInsertDNDBTScriptExecutionRecordQuery : InsertDNDBTScriptExecutionRecordQuery
{
    public MySQLInsertDNDBTScriptExecutionRecordQuery(Script script, long executedOnDbVersion)
