...
internal class PostgreSQLInsertDNDBTScriptExecutionRecordQuery : InsertDNDBTScriptExecutionRecordQuery
{
    public PostgreSQLInsertDNDBTScriptExecutionRecordQuery(Script script, long executedOnDbVersion)
