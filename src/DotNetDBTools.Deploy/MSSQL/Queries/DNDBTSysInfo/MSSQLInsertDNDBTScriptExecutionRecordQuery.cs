...
internal class MSSQLInsertDNDBTScriptExecutionRecordQuery : InsertDNDBTScriptExecutionRecordQuery
{
    public MSSQLInsertDNDBTScriptExecutionRecordQuery(Script script, long executedOnDbVersion)
