...
DECLARE @Metadata NVARCHAR(MAX) = '{
  "Columns": {
    "$type": "System.Collections.Generic.List`1[[DotNetDBTools.Models.MSSQL.MSSQLColumnInfo, DotNetDBTools.Models.MSSQL]], System.Private.CoreLib",
    "$values": [
      {
        "DataType": "INT",
        "DefaultValue": 333,
  ...
  "ForeignKeys": {
    "$type": "System.Collections.Generic.List`1[[DotNetDBTools.Models.MSSQL.MSSQLForeignKeyInfo, DotNetDBTools.Models.MSSQL]], System.Private.CoreLib",
    "$values": []
  },
